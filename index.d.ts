...
export declare class PageSystem {
    ...
    next(): false | Promise<import("discord-api-types").APIMessage | Message<boolean>> | this;
    previous(): false | Promise<import("discord-api-types").APIMessage | Message<boolean>> | this;
    setIndex(index: number): Promise<import("discord-api-types").APIMessage | Message<boolean>> | this;
